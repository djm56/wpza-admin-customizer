 ...
 * @subpackage Wpza_Admin_Customizer/admin
 */
 ...
 */
class Wpza_Admin_Customizer_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Wpza_Admin_Customizer_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Wpza_Admin_Customizer_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wpza-admin-customizer-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wpza-admin-customizer-admin.js', array( 'jquery' ), $this->version, false );
    ...
    public function create_menu() {
		...
		*/
		...
		$config_submenu = array(
			...
			'title'             => esc_html__( 'Admin Customizer', 'wpza-admin-customizer' ),    //The name of this page
			'capability'        => 'manage_options',                                // The capability needed to view the page
			'plugin_basename'   => plugin_basename( plugin_dir_path( __DIR__ ) . $this->plugin_name . '.php' ),
			'tabbed'            => true,
